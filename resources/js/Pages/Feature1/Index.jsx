        ...
        <FeatureComponent feature={feature} answer={answer}>
            <form onSubmit={submit} className="p-8 grid grid-cols-2 gap-3">
                <div className="">
                    ...
                    <InputError message={errors.number1} className="mt-2"></InputError>
                </div>

                <div>
                    <InputLabel className="text-white" htmlFor="number2" value="Number 2" />
                    ...
                    <InputError message={errors.number2} className="mt-2"></InputError>
                </div>
